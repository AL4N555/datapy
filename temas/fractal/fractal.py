...
archivo_excel = 'Excel.xlsx'  # Nombre del archivo Excel
...
# Asegurarnos de que la columna 'Serie' existe
if 'Serie' not in df.columns:
    raise ValueError("La columna 'Serie' no se encuentra en el archivo Excel.")

# Suponemos que la columna que queremos analizar se llama 'Serie'
serie = df['Serie'].head(10)  # Limitar a los primeros 10 elementos
